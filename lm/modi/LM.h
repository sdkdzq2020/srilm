...
public:
    ...
    virtual LogP sentenceProb(const VocabIndex *sentence, TextStats &stats, vector<string> &printProbVec);
    virtual LogP sentenceProb(const VocabString *sentence, TextStats &stats, vector<string> &printProbVec);
    ...
    virtual unsigned pplFile(char* getline, TextStats &stats,
		string &segResult, vector<string> &WordProbVec,const char *escapeString = 0, Boolean weighted = false);
