...
main(int argc, char **argv)
{
	...
	* Compute perplexity on a text file, if requested
	ÈçÏÂ´Ë´¦£¬Îª¶ÁÈë´ý²âÊÔÎÄ¼þÖÐ¾ä×Ó£¬º¯ÊýÄÚ¸ø³öÃ¿¸ö¾ä×Ó·Ö´Ê½á¹ûµÄÈë¿Ú
	useLMÎª´ýÊ¹ÓÃngramLM£¬fileÎªº¬ÓÐ´ý·Ö´ÊµÄ¾ä×ÓµÄÎÄ¼þ
	*/
	char* getline;
	char* buffer;
	...
	//		else
				cmd = "python " + subcwd + "//StartTextCleanOneLine.py " +templine;
		//cout<<"cmd:"<<cmd<<endl;
